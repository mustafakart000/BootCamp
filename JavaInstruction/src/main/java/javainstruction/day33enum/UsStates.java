...
public enum UsStates {
   ...
   /* public String getStatNameFromAbbreviation(String abbrevation) {
        Arrays.stream(values()).filter(UsStates ->UsStates.getAbbreviation().equals(abbreviation)).findFirst().get().getStateName();
    }*/
}
