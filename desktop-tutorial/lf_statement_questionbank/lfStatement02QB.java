...
//----------------------------------------------------------------------------------------------------------------------
        ...
        if (psw==e){
            ...
            //yapıalcak işlemler
            System.out.println( "Lütfen yapcağınız işlemi seçiniz para çekme 1 yatırma 2 görüntüleme 3 çıkmak için 4 yazın: ");
            int islem= scan.nextInt();
            double userParaAl=0;
            double kalan=0;
            switch (islem){
                case 1:
                    System.out.println("çekebileceğiniz maximum bakiye "+bakiye+" Lütfen çekmek istediğiniz miktarı yazınız: ");
                    ...
                    if (bakiye<userParaAl){
                        ...
                        System.out.println("çekmiş oldugunuz  "+userParaAl+"TL bakiyeden sonra hesabınız da kalan bakiye "+kalan+" TL'dir");
                    }
